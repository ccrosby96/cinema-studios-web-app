...
function SeasonResultsList (seasons = [
    {
        "air_date": "2013-04-24",
        "episode_count": 13,
        "id": 82137,
    ...
    console.log("shows in SeasonResultsList", seasons)
    return (
        <>
            <ul className= "list-group no-bullets">
                {
                    seasons.seasons.map((season, i) => {
                        ...
                        return (
                            <Link to = {`/tv/series/${season.id}`} className = "text-decoration-none">
...
export default SeasonResultsList;